...
const updateUser = (userId, payload, decodedToken) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const isAdmin = decodedToken.role.includes(user_interface_1.Role.ADMIN) || decodedToken.role.includes(user_interface_1.Role.SUPER_ADMIN);
    ...
    if (payload.role) {
        if (!isAdmin) {
            throw new AppError_1.default(http_status_codes_1.default.FORBIDDEN, "Only Admins can update roles");
        }
        if (payload.role.includes(user_interface_1.Role.SUPER_ADMIN) &&
            decodedToken.role.includes(user_interface_1.Role.ADMIN)) {
            throw new AppError_1.default(http_status_codes_1.default.FORBIDDEN, "Only Super Admin can promote to SUPER_ADMIN");
        }
    }
    if ((payload.isActive !== undefined || payload.isDeleted !== undefined) && !isAdmin) {
        throw new AppError_1.default(http_status_codes_1.default.FORBIDDEN, "Only Admins can update user status");
    }
    if (payload.password) {
